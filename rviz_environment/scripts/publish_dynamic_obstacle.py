...
def publish_obstacle_msg():
  ...
  obstacle_msg.obstacles[0].velocities.twist.linear.z = 0.2
  obstacle_msg.obstacles[0].velocities.twist.angular.x = 0.2
  obstacle_msg.obstacles[0].velocities.twist.angular.y = 0.2
  obstacle_msg.obstacles[0].velocities.twist.angular.z = 0.2
